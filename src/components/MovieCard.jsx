export default function MovieCard({ setActiveMovie, movieData }) {
  return (
    <div
      className="movie-card flex flex-col justify-center items-center m-2 mt-3 p-5 pb-3 bg-slate-900 hover:bg-slate-800/90 hover:cursor-pointer hover:scale-102 transition rounded-2xl w-56"
